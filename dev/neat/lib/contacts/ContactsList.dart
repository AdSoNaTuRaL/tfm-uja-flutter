  ...
  Future _deleteContact(BuildContext context, Contact contact) {
    return showDialog(
      ...
      builder: (BuildContext alertContext) {
        return AlertDialog(
          title: Text(AppLocalizations.of(context).translate('contact_delete')),
          content: Text('${AppLocalizations.of(context).translate('really_delete')} ${contact.name}?'),
          actions: [
            TextButton(
              ...
              onPressed: () async {
                ...
                Scaffold.of(context).showSnackBar(
                  SnackBar(
                    ...
                    content: Text(AppLocalizations.of(context).translate('contact_deleted')),
                  )
                );
